...
### Correlation matrix for the weather variables
```{r}
no.na.data = na.omit(data_exercises_top_1)
top_1_exercise_lm_out = lm(Total_Duration ~ 
                        avg_relative_humidity +
                        avg_dew_point +
                        avg_pressure_sea +
                      ...
                      data = no.na.data)
step(top_1_exercise_lm_out,direction="backward")
#plot(top_1_exercise_lm_out$residuals, top_1_exercise_lm_out$fitted.values)
summary(top_1_exercise_lm_out)
